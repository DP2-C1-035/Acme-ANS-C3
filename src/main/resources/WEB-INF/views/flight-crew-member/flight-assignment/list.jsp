...
<acme:list>
	...
	<acme:list-column code="flight-crew-member.flight-assignment.form.label.flight-crew-duty" path="flightCrewDuty" width="10%"/>
	<acme:list-column code="flight-crew-member.flight-assignment.form.label.assignment-status" path="assignmentStatus" width="10%"/>
	<acme:list-column code="flight-crew-member.flight-assignment.form.label.last-update" path="lastUpdate" width="15%"/>
