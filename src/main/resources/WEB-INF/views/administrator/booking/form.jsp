...
<acme:form>
		...
		<acme:input-textbox code="administrator.booking.form.label.creditCardNibble" path="creditCardNibble" placeholder="administrator.booking.form.placeholder.creditCardNibble"/>
