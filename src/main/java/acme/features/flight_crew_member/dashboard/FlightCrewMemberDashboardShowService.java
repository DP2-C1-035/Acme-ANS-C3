...
public class FlightCrewMemberDashboardShowService extends AbstractGuiService<FlightCrewMember, FlightCrewMemberDashboard> {
	...
	public void load() {
		...
		List<String> flightAssignmentsPending = this.repository.findFlightAssignmentsByStatus(flightCrewMemberId, AssignmentStatus.PENDING);
		List<String> flightAssignmentsConfirmed = this.repository.findFlightAssignmentsByStatus(flightCrewMemberId, AssignmentStatus.CONFIRMED);
		List<String> flightAssignmentsCancelled = this.repository.findFlightAssignmentsByStatus(flightCrewMemberId, AssignmentStatus.CANCELLED);
